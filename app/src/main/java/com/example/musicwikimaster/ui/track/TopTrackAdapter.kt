...
class TopTrackAdapter(private val context: Context?, private val mList: List<Track> = emptyList()) :
  ...
  fun setTagList(mlist: List<Track>) {
    this.list = mlist
    notifyDataSetChanged()
  }

  override fun onBindViewHolder(holder: TagViewHolder, position: Int) {
    val artist: Track = list[position]
...
class TagViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
  ...
  fun bind(artist: Track, context: Context?) {
